                            ...
                            <div class="d-flex align-items-center justify-content-md-end">
                                ...
                                <div class="avatar-list-stacked avatar-group-sm ms-4">
                                    <span class="avatar avatar-rounded">
                                        <img class="border border-white" src="{{ asset('admintemplate/assets/img/profiles/avatar-02.jpg') }}"
                                            alt="img">
                                    </span>
                                    <span class="avatar avatar-rounded">
                                        <img class="border border-white" src="{{ asset('admintemplate/assets/img/profiles/avatar-03.jpg') }}"
                                            alt="img">
                                    </span>
                                    <span class="avatar avatar-rounded">
                                        <img class="border border-white" src="{{ asset('admintemplate/assets/img/profiles/avatar-05.jpg') }}"
                                            alt="img">
                                    </span>
                                    <span class="avatar avatar-rounded">
                                        <img class="border border-white" src="{{ asset('admintemplate/assets/img/profiles/avatar-06.jpg') }}"
                                            alt="img">
                                    </span>
                                    <span class="avatar avatar-rounded">
                                        <img class="border border-white" src="{{ asset('admintemplate/assets/img/profiles/avatar-07.jpg') }}"
                                            alt="img">
                                    </span>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border avatar-rounded">
                                                <img src="{{ asset('admintemplate/assets/img/users/user-09.jpg') }}" class="img-fluid" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border avatar-rounded">
                                                <img src="{{ asset('admintemplate/assets/img/users/user-01.jpg') }}" class="img-fluid" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border avatar-rounded">
                                                <img src="{{ asset('admintemplate/assets/img/users/user-33.jpg') }}" class="img-fluid" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border avatar-rounded">
                                                <img src="{{ asset('admintemplate/assets/img/users/user-34.jpg') }}" class="img-fluid" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border avatar-rounded">
                                                <img src="{{ asset('admintemplate/assets/img/users/user-35.jpg') }}" class="img-fluid" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border avatar-rounded">
                                                <img src="{{ asset('admintemplate/assets/img/users/user-30.jpg') }}" class="img-fluid" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border avatar-rounded">
                                                <img src="{{ asset('admintemplate/assets/img/users/user-36.jpg') }}" class="img-fluid" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md border avatar-rounded">
                                                <img src="{{ asset('admintemplate/assets/img/users/user-38.jpg') }}" class="img-fluid" alt="img">
                                            </a>
                                            <div class="ms-2">
