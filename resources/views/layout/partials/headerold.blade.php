                                ...
                                <div class="d-flex flex-column">
                                        ...
                                        <a href="{{url('activity')}}">
                                            <div class="d-flex">
                                                <span class="avatar avatar-lg me-2 flex-shrink-0">
                                                    <img src="{{asset('admintemplate/assets/img/profiles/avatar-27.jpg')}}" alt="Profile">
                                                </span>
                                    ...
                                    <div class="border-bottom mb-3 pb-3">
                                        <a href="{{url('activity')}}" class="pb-0">
                                            <div class="d-flex">
                                                <span class="avatar avatar-lg me-2 flex-shrink-0">
                                                    <img src="{{asset('admintemplate/assets/img/profiles/avatar-23.jpg')}}" alt="Profile">
                                                </span>
                                                <div class="flex-grow-1">
                                                    <p class="mb-1"><span
                                    ...
                                    <div class="border-bottom mb-3 pb-3">
                                        <a href="{{url('activity')}}">
                                            <div class="d-flex">
                                                <span class="avatar avatar-lg me-2 flex-shrink-0">
                                                    <img src="{{asset('admintemplate/assets/img/profiles/avatar-25.jpg')}}" alt="Profile">
                                                </span>
                                                <div class="flex-grow-1">
                                    ...
                                    <div class="border-0 mb-3 pb-0">
                                        <a href="{{url('activity')}}">
                                            <div class="d-flex">
                                                <span class="avatar avatar-lg me-2 flex-shrink-0">
                                                    <img src="{{asset('admintemplate/assets/img/profiles/avatar-01.jpg')}}" alt="Profile">
                                                </span>
                                                <div class="flex-grow-1">
                    ...
                    <div class="dropdown profile-dropdown">
                        <a href="javascript:void(0);" class="dropdown-toggle d-flex align-items-center"
                            ...
                            <span class="avatar avatar-sm online">
                                <img src="{{asset('admintemplate/assets/img/profiles/avatar-12.jpg')}}" alt="Img" class="img-fluid rounded-circle">
                            </span>
                        </a>
                            ...
                            <div class="card mb-0">
                                ...
                                <div class="card-footer">
                                    ...
                                    <form method="POST" action="{{ route('logout') }}">
                                        ...
                                        <button type="submit"
                                            class="dropdown-item d-inline-flex align-items-center p-0 py-2 border-0 bg-transparent">
