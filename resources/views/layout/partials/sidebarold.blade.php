...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-logo">
        <a href="{{url('index')}}" class="logo logo-normal">
            <img src="{{asset('admintemplate/assets/img/logo.svg')}}" alt="Logo">
        </a>
        <a href="{{url('index')}}" class="logo-small">
            <img src="{{asset('admintemplate/assets/img/logo-small.svg')}}" alt="Logo">
        </a>
        <a href="{{url('index')}}" class="dark-logo">
            <img src="{{asset('admintemplate/assets/img/logo-white.svg')}}" alt="Logo">
        </a>
    </div>
    <!-- /Logo -->
    <div class="modern-profile p-3 pb-0">
        <div class="text-center rounded bg-light p-3 mb-4 user-profile">
            <div class="avatar avatar-lg online mb-3">
                <img src="{{asset('admintemplate/assets/img/profiles/avatar-02.jpg')}}" alt="Img" class="img-fluid rounded-circle">
            </div>
    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li>
                    <ul>
                        <li class="submenu">
                            ...
                            <ul>
                                <!--li><a href="{ {route('admin.dashboard.index')}}" class="{ { Request::is(route('admin.dashboard.index')) ? 'active' : '' }}">Admin Dashboard</a></li-->
                        ...
                        <!--li class="submenu">
                            ...
                            'calendar','email','todo','notes','social-feed','file-manager','kanban-view','invoices','invoice-details') ? 'active subdrop' : '' }}">
                                <i class="fa fa-table" style="font-size:10px"></i><span>Tables de codes</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul>
                                ...
                                <li><a href="{ {route('admin.poste.index')}}" class="{ { Request::is(route('admin.poste.index')) ? 'active' : '' }}">Poste</a></li>
                                <li><a href="{ {route('admin.service.index')}}" class="{ { Request::is(route('admin.service.index')) ? 'active' : '' }}">Service</a></li>
                                <li><a href="{ {route('admin.activité.index')}}" class="{ { Request::is(route('admin.activité.index')) ? 'active' : '' }}">Activité</a></li>
                ...
                <li class="menu-title"><span>GESTION DE VOITURES</span></li>
                <li>
                    <ul>
                        <!--li class="submenu">
                            <a href="javascript:void(0);" class="{ { Request::is('employees','employees-grid','employee-details','departments','designations','policy') ? 'active subdrop' : '' }}">
                                <i class="ti ti-users"></i><span>Gestion des voitures</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul>
                                <li><a href="{ {route('vehicles.index')}}" class="{ { Request::is(route('vehicles.index')) ? 'active' : '' }}">Listes des voiture</a></li>
                        ...
                        <li class="submenu">
                                ...
                                class="{{ Route::is('vehicles.*') ? 'active subdrop' : '' }}">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        class="{{ Route::is('vehicles.index') ? 'active' : '' }}">
                                        Liste des voitures
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        class="{ { Route::is('vehicles.create') ? 'active' : '' }}">
                                        Ajouter une voiture
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <li class="submenu">
                            ...
                            'timesheets','schedule-timing','overtime') ? 'active subdrop' : '' }}">
                                ...
                                <i class="ti ti-file-time"></i><span>Gestion des congés</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <!--ul>

                                <li><a href="{ {route('admin.congé.index')}}" class="{ { Request::is(route('admin.congé.index')) ? 'active' : '' }}">Listes des congés</a></li>
                                <li><a href="{ {url('overtime')}}" class="{ { Request::is('overtime') ? 'active' : '' }}">Overtime</a></li>
                                <li><a href="{ {url('overtime')}}" class="{ { Request::is('overtime') ? 'active' : '' }}">Formulaire de demande de congé</a></li>
                                <li><a href="{ {route('admin.ReliquatCongé.index')}}" class="{ { Request::is(route('admin.ReliquatCongé.index')) ? 'active' : '' }}">Reliquat congé</a></li>
                            </ul-->
                        </li>
                                <!-- --------------- Overtime ---------------------------------- -->
                        <li class="submenu">
                            <a href="javascript:void(0);" class="{ { Request::is('leaves','leaves-employee','leave-settings','attendance-admin','attendance-employee',
                            'timesheets','schedule-timing','overtime') ? 'active subdrop' : '' }}">
                                <i class="ti ti-file-time"></i><span>Gestion des heures sup.</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul>

                                <li><a href="{ {route('admin.ReliquatCongé.index')}}" class="{ { Request::is(route('admin.ReliquatCongé.index')) ? 'active' : '' }}">Listes des reliquat congé</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="{{ Request::is('employees','employees-grid','employee-details','departments','designations','policy') ? 'active subdrop' : '' }}">
                                ...
                                <i class="ti ti-users"></i><span>Gestion des absences</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul>
                                <!--li><a href="{ {route('admin.absence.index')}}" class="{ { Request::is(route('admin.employé.index2')) ? 'active' : '' }}">Listes des employés absent(e)s</a></li-->
                ...
                <li class="menu-title"><span>GESTION DE SALAIRE</span></li>
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);" class="{{ Request::is('employee-salary','payslip','payroll') ? 'active subdrop' : '' }}">
                                ...
                                <i class="ti ti-cash"></i><span>Paie</span>
                                <span class="menu-arrow"></span>
                            </a>
                            <ul>
                                <li><a href="{{url('employee-salary')}}" class="{{ Request::is('employee-salary') ? 'active' : '' }}">Salaire de l'employé(e)</a></li>
                                <li><a href="{{url('payslip')}}" class="{{ Request::is('payslip') ? 'active' : '' }}">Bulletin de paie</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                    ...
                    <!--   Table des codes ------------------------------- -->
                <li class="menu-title"><span>Gestion de tables de codes</span></li>
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <!--ul>
                                ...
                                <li><a href="{ {route('admin.service.index')}}" class="{ { Request::is(route('admin.service.index')) ? 'active' : '' }}">Service</a></li>
                                <li><a href="{ {route('admin.activité.index')}}" class="{ { Request::is(route('admin.activité.index')) ? 'active' : '' }}">Activité</a></li>
                                <li><a href="{ {route('admin.type_congé.index')}}" class="{ { Request::is(route('admin.type_congé.index')) ? 'active' : '' }}">Type de congé</a></li>
                                <li><a href="{ {route('admin.motif_absence.index')}}" class="{ { Request::is(route('admin.motif_absence.index')) ? 'active' : '' }}">Motif d'absence</a></li>
                                <li><a href="{ {route('admin.année.index')}}" class="{ { Request::is(route('admin.année.index')) ? 'active' : '' }}">Année</a></li>
        ...
        <div class="main-menu">
            ...
            <div class="d-xl-flex align-items-center d-none">
                <a href="#" class="me-3 avatar avatar-sm">
                    <img src="{{asset('admintemplate/assets/img/profiles/avatar-07.jpg')}}" alt="profile" class="rounded-circle">
                </a>
