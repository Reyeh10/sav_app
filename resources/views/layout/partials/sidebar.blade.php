...
<div class="sidebar" id="sidebar">
            ...
            <!--div class="sidebar-logo text-center py-3">
                ...
                <a href="{ { url('/dashboard') }}" class="logo logo-normal">
                    <img src="{ { asset('images/stcd.jpg') }}"
                        alt="STCD Logo"
                        style="max-height:60px;">
                </a>
            </div-->
            <div class="sidebar-logo py-3 px-3">
                    ...
                    @if(auth()->user()->role === 'admin')
                        ...
                        @if(in_array(auth()->user()->role, ['admin','logistique','mecanicien','vendeur']))
                            <li>
                                ...
                                class="{{ request()->routeIs('vehicles.grid') ? 'active' : '' }}">
                                    <i class="ti ti-layout-grid me-2 text-info"></i>
                                    Grille véhicules
                                </a>
                            </li>
                        @endif
                        ...
                        @if(in_array(auth()->user()->role, ['admin','logistique']))
                            <li>
                                ...
                                class="{{ request()->routeIs('vehicles.create') ? 'active' : '' }}">
                                    <i class="ti ti-circle-plus me-2 text-primary"></i>
                                    Ajouter véhicule
                                </a>
                            </li>
                        @endif
                        {{-- ================= VOITURES VENDUES ================= --}}
                        @if(auth()->user()->role == 'vendeur'  || auth()->user()->role == 'mecanicien' || auth()->user()->role == 'logistique'|| auth()->user()->role == 'admin')

                        <li>
                            <a href="{{ route('vehicles.sold') }}"
                            class="{{ request()->routeIs('vehicles.sold') ? 'active' : '' }}">
                        ...
                        @if(in_array(auth()->user()->role, ['admin','logistique']))
                            <li>
                                <a href="#" data-bs-toggle="modal" data-bs-target="#importExcelModal">
                                    <i class="ti ti-file-import me-2 text-success"></i>
                                    Import Excel
                                </a>
                            </li>
                        @endif
                        ...
                        @if(auth()->user()->role == 'vendeur')
                            ...
                            <li>
                                <a href="{{ route('vehicles.approved') }}"
                                class="{{ request()->routeIs('vehicles.approved') ? 'active' : '' }}">
                            ...
                            <li>
                                ...
                                class="{{ request()->routeIs('sales.create') ? 'active' : '' }}">
                                    <i class="ti ti-cash me-2 text-warning"></i>
                                    Vendre une voiture
                                </a>
                            </li>
                        ...
                        @if(in_array(auth()->user()->role, ['admin','vendeur']))
                            ...
                            <li>
                                ...
                                class="{{ request()->routeIs('customers.index') ? 'active' : '' }}">
                                    <i class="ti ti-users me-2 text-info"></i>
                                    Liste des clients
                                </a>
                            </li>
