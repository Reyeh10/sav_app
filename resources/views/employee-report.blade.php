                ...
                <div class="row flex-fill">
                        ...
                        <div class="card flex-fill">
                            <div class="card-body">
                                <div class="overflow-hidden d-flex mb-2 align-items-center">
                                    <span class="me-2"><img src="{{ asset('admintemplate/assets/img/reports-img/employee-report-icon.svg') }}" alt="Img" class="img-fluid"></span>
                                   <div>
                    ...
                    <div class="col-lg-6 col-md-6 d-flex">
                        <div class="card flex-fill">
                            <div class="card-body">
                                <div class="overflow-hidden d-flex mb-2 align-items-center">
                                    <span class="me-2"><img src="{{ asset('admintemplate/assets/img/reports-img/employee-report-success.svg') }}" alt="Img" class="img-fluid"></span>
                                   <div>
                    ...
                    <div class="col-lg-6 col-md-6 d-flex">
                        <div class="card flex-fill">
                            <div class="card-body">
                                <div class="overflow-hidden d-flex mb-2 align-items-center">
                                    <span class="me-2"><img src="{{ asset('admintemplate/assets/img/reports-img/employee-report-info.svg') }}" alt="Img" class="img-fluid"></span>
                                   <div>
                    ...
                    <div class="col-lg-6 col-md-6 d-flex">
                        <div class="card flex-fill">
                            <div class="card-body">
                                <div class="overflow-hidden d-flex mb-2 align-items-center">
                                    <span class="me-2"><img src="{{ asset('admintemplate/assets/img/reports-img/employee-report-danger.svg') }}" alt="Img" class="img-fluid"></span>
                                   <div>
