                                    ...
                                    <div class="col-md-10">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-xxl rounded me-3">
                                                <img src="{{ asset('admintemplate/assets/img/blog-2/blog-01.jpg') }}" class="rounded" alt="Img">
                                            </div>
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-xs avatar-rounded me-2">
                                                        <img src="{{ asset('admintemplate/assets/img/users/user-29.jpg') }}" alt="Img">
                                                    </span>
                                    ...
                                    <div class="col-md-10">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-xs avatar-rounded me-2">
                                                        <img src="{{ asset('admintemplate/assets/img/users/user-05.jpg') }}" alt="Img">
                                                    </span>
                                    ...
                                    <div class="col-md-10">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-xs avatar-rounded me-2">
                                                        <img src="{{ asset('admintemplate/assets/img/users/user-22.jpg') }}" alt="Img">
                                                    </span>
                                    ...
                                    <div class="col-md-10">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-xs avatar-rounded me-2">
                                                        <img src="{{ asset('admintemplate/assets/img/users/user-52.jpg') }}" alt="Img">
                                                    </span>
