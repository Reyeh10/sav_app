                    ...
                    <div class="card card-bg-1">
                        <div class="card-body p-0">
                            <span class="avatar avatar-xl avatar-rounded border border-2 border-white m-auto d-flex mb-2">
                                <img src="{{ asset('admintemplate/assets/img/profiles/avatar-19.jpg') }}" class="w-auto h-auto" alt="Img">
                            </span>
                                            ...
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div>
                                                    <h6 class="fw-medium d-flex align-items-center mb-1">
                                                        Meeting With
                                                        <span class="avatar avatar-sm avatar-rounded mx-1"><img src="{{ asset('admintemplate/assets/img/profiles/avatar-02.jpg') }}" alt="Img"></span>
                                                        Abraham
                                                    </h6>
                                                            ...
                                                            <div class="dropdown">
                                                                <a href="javascript:void(0);" class="dropdown-toggle btn btn-sm btn-white d-inline-flex align-items-center" data-bs-toggle="dropdown">
                                                                    <span class="avatar avatar-xs avatar-rounded me-1">
                                                                        <img src="{{ asset('admintemplate/assets/img/profiles/avatar-02.jpg') }}" alt="Img">
                                                                    </span>
                                                                    John
                                                                </a>
                                                                <ul class="dropdown-menu  dropdown-menu-end p-3">
                                                                    ...
                                                                    <li>
                                                                        <a href="javascript:void(0);" class="dropdown-item rounded-1 d-flex align-items-center">
                                                                            <span class="avatar avatar-xs avatar-rounded me-1">
                                                                                <img src="{{ asset('admintemplate/assets/img/profiles/avatar-01.jpg') }}" alt="Img">
                                                                            </span>
                                                                            Sophie
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="javascript:void(0);" class="dropdown-item rounded-1 d-flex align-items-center">
                                                                            <span class="avatar avatar-xs avatar-rounded me-1">
                                                                                <img src="{{ asset('admintemplate/assets/img/profiles/avatar-03.jpg') }}" alt="Img">
                                                                            </span>
                                                                            Estelle
                                                                        </a>
                                                                    </li>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-3">
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
                                                        <img src="{{ asset('admintemplate/assets/img/profiles/avatar-19.jpg') }}" alt="Img">
                                                    </span>
                                                    <div>
                                                    ...
                                                    <div class="border rounded d-flex align-items-center justify-content-between hover-border p-3">
                                                        <div class="d-flex align-items-center me-4">
                                                            <span class="avatar avatar-lg avatar-rounded flex-shrink-0 me-2">
                                                                <img src="{{ asset('admintemplate/assets/img/media/media-07.jpg') }}" alt="Img">
                                                            </span>
                                                            <div>
                                        ...
                                        <div class="border rounded p-3 mb-3">
                                            <div class="d-flex align-items-center justify-content-between mb-3">
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
                                                        <img src="{{ asset('admintemplate/assets/img/profiles/avatar-04.jpg') }}" alt="Img">
                                                    </span>
                                                    <div>
