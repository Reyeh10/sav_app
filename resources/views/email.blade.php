                        ...
                        <div class="slimscroll-active-sidebar">
                            ...
                            <div class="list-group list-group-flush mails-list">
                                ...
                                <div class="list-group-item border-bottom p-3">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <a href="javascript:void(0);"><img src="{{ asset('admintemplate/assets/img/icons/google-meet.svg') }}" alt="Img"></a>
                                        <div class="d-flex align-items-center">
                                            <span><i class="ti ti-star-filled text-warning"></i></span>
                                ...
                                <div class="list-group-item border-bottom p-3">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                            <a href="{{url('email-reply')}}" class="avatar avatar-md avatar-rounded me-2">
                                                <img src="{{ asset('admintemplate/assets/img/profiles/avatar-05.jpg') }}" alt="Img">
                                            </a>
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-start justify-content-between">
                                                    <div>
                                ...
                                <div class="list-group-item border-bottom p-3">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                            <a href="{{url('email-reply')}}" class="avatar avatar-md avatar-rounded me-2">
                                                <img src="{{ asset('admintemplate/assets/img/profiles/avatar-08.jpg') }}" alt="Img">
                                            </a>
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-start justify-content-between">
                                                    <div>
                                ...
                                <div class="list-group-item p-3">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap row-gap-2 flex-fill">
                                            <a href="{{url('email-reply')}}" class="avatar avatar-md avatar-rounded me-2">
                                                <img src="{{ asset('admintemplate/assets/img/profiles/avatar-07.jpg') }}" alt="Img">
                                            </a>
                                            <div class="flex-fill">
                                                <div class="d-flex align-items-start justify-content-between">
                                                    <div>
