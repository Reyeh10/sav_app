                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('contact-details')}}" class="avatar avatar-md border avatar-rounded">
                                                        <img src="{{ asset('admintemplate/assets/img/users/user-49.jpg') }}" class="img-fluid" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('contact-details')}}" class="avatar avatar-md border avatar-rounded">
                                                        <img src="{{ asset('admintemplate/assets/img/users/user-50.jpg') }}" class="img-fluid" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('contact-details')}}" class="avatar avatar-md border avatar-rounded">
                                                        <img src="{{ asset('admintemplate/assets/img/users/user-51.jpg') }}" class="img-fluid" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('contact-details')}}" class="avatar avatar-md border avatar-rounded">
                                                        <img src="{{ asset('admintemplate/assets/img/users/user-02.jpg') }}" class="img-fluid" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('contact-details')}}" class="avatar avatar-md border avatar-rounded">
                                                        <img src="{{ asset('admintemplate/assets/img/users/user-52.jpg') }}" class="img-fluid" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('company-details')}}" class="avatar avatar-md border rounded-circle">
                                                        <img src="{{ asset('admintemplate/assets/img/company/company-01.svg') }}" class="img-fluid" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('company-details')}}" class="avatar avatar-md border rounded-circle">
                                                        <img src="{{ asset('admintemplate/assets/img/company/company-02.svg') }}" class="img-fluid" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('company-details')}}" class="avatar avatar-md border rounded-circle">
                                                        <img src="{{ asset('admintemplate/assets/img/company/company-03.svg') }}" class="img-fluid" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('company-details')}}" class="avatar avatar-md border rounded-circle">
                                                        <img src="{{ asset('admintemplate/assets/img/company/company-04.svg') }}" class="img-fluid" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center file-name-icon">
                                                    <a href="{{url('company-details')}}" class="avatar avatar-md border rounded-circle">
                                                        <img src="{{ asset('admintemplate/assets/img/company/company-05.svg') }}" class="img-fluid" alt="img">
                                                    </a>
                                                    <div class="ms-2">
