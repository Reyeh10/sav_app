                        ...
                        <div class="card-header bg-dark">
                            <div class="d-flex align-items-center">
                                <span class="avatar avatar-lg avatar-rounded border border-white border-2 flex-shrink-0 me-2">
                                    <img src="{{ asset('admintemplate/assets/img/users/user-01.jpg') }}" alt="Img">
                                </span>
                                <div>
                                    ...
                                    <div class="card shadow-none mb-0">
                                        <div class="card-body">
                                            ...
                                            <div>
                                                <div class="d-flex align-items-center mb-3">
                                                    <a href="javascript:void(0);" class="avatar">
                                                        <img src="{{ asset('admintemplate/assets/img/users/user-33.jpg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                                        <h6 class="fw-normal"><a href="javascript:void(0);">Anthony Lewis</a></h6>
                                                        <span class="fs-13 d-block">Project Leader</span>
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <span class="avatar avatar-xl avatar-rounded mb-2">
                                        <img src="{{ asset('admintemplate/assets/img/users/user-35.jpg') }}" alt="Img">
                                    </span>
                                    <div class="mb-3">
                    ...
                    <div class="card flex-fill">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="{{ asset('admintemplate/assets/img/users/user-27.jpg') }}" class="rounded-circle border border-2" alt="img">
                                    </a>
                                    <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="{{ asset('admintemplate/assets/img/users/user-42.jpg') }}" class="rounded-circle border border-2" alt="img">
                                    </a>
                                    <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="{{ asset('admintemplate/assets/img/users/user-43.jpg') }}" class="rounded-circle border border-2" alt="img">
                                    </a>
                                    <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="{{ asset('admintemplate/assets/img/users/user-11.jpg') }}" class="rounded-circle border border-2" alt="img">
                                    </a>
                                    <div class="ms-2">
                                        <h6 class="fs-14 fw-medium text-truncate mb-1"><a href="#">Daniel Esbella</a></h6>
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="{{ asset('admintemplate/assets/img/users/user-44.jpg') }}" class="rounded-circle border border-2" alt="img">
                                    </a>
                                    <div class="ms-2">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center">
                                    <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                        <img src="{{ asset('admintemplate/assets/img/users/user-54.jpg') }}" class="rounded-circle border border-2" alt="img">
                                    </a>
                                    <div class="ms-2">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start mb-4">
                                ...
                                <div class="ms-2">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <a href="#" class="avatar avatar-sm border flex-shrink-0 me-2"><img src="{{ asset('admintemplate/assets/img/social/pdf-icon.svg') }}" class="w-auto h-auto" alt="Img"></a>
                            ...
                            <div class="d-flex align-items-start mb-4">
                                <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                    <img src="{{ asset('admintemplate/assets/img/users/user-28.jpg') }}" class="rounded-circle border border-2" alt="img">
                                </a>
                                <div class="ms-2">
                                    <h6 class="fs-14 fw-medium text-truncate mb-1">Lex Murphy requested access to UNIX </h6>
                            ...
                            <div class="d-flex align-items-start mb-4">
                                <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                    <img src="{{ asset('admintemplate/assets/img/users/user-30.jpg') }}" class="rounded-circle border border-2" alt="img">
                                </a>
                                <div class="ms-2">
                                    <h6 class="fs-14 fw-medium text-truncate mb-1">Lex Murphy requested access to UNIX </h6>
                            ...
                            <div class="d-flex align-items-start">
                                <a href="javascript:void(0);" class="avatar flex-shrink-0">
                                    <img src="{{ asset('admintemplate/assets/img/users/user-33.jpg') }}" class="rounded-circle border border-2" alt="img">
                                </a>
                                <div class="ms-2">
                                    <h6 class="fs-14 fw-medium text-truncate mb-1">Lex Murphy requested access to UNIX </h6>
