                            ...
                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md rounded-circle bg-gray-100 flex-shrink-0 me-2">
                                                <img src="{{ asset('admintemplate/assets/img/company/company-24.svg') }}" class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md rounded-circle bg-gray-100 flex-shrink-0 me-2">
                                                <img src="{{ asset('admintemplate/assets/img/company/company-25.svg') }}" class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md rounded-circle bg-gray-100 flex-shrink-0 me-2">
                                                <img src="{{ asset('admintemplate/assets/img/company/company-26.svg') }}" class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2 mb-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md rounded-circle bg-gray-100 flex-shrink-0 me-2">
                                                <img src="{{ asset('admintemplate/assets/img/company/company-27.svg') }}" class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                                ...
                                <div class="border border-dashed bg-transparent-light rounded p-2">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);" class="avatar avatar-md rounded-circle bg-gray-100 flex-shrink-0 me-2">
                                                <img src="{{ asset('admintemplate/assets/img/company/company-28.svg') }}" class="w-auto h-auto" alt="Img">
                                            </a>
                                            <div>
                                    ...
                                    <tbody>
                                            ...
                                            <td class="px-0">
                                                <div class="d-flex align-items-center mb-2">
                                                    <a href="{{url('countries')}}" class="avatar rounded-circle border border-2">
                                                        <img src="{{ asset('admintemplate/assets/img/payment-gateway/country-01.svg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            <td class="px-0">
                                                <div class="d-flex align-items-center mb-2">
                                                    <a href="{{url('countries')}}" class="avatar rounded-circle border border-2">
                                                        <img src="{{ asset('admintemplate/assets/img/payment-gateway/country-02.svg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            <td class="px-0">
                                                <div class="d-flex align-items-center mb-2">
                                                    <a href="{{url('countries')}}" class="avatar rounded-circle border border-2">
                                                        <img src="{{ asset('admintemplate/assets/img/payment-gateway/country-03.svg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            <td class="px-0">
                                                <div class="d-flex align-items-center mb-2">
                                                    <a href="{{url('countries')}}" class="avatar rounded-circle border border-2">
                                                        <img src="{{ asset('admintemplate/assets/img/payment-gateway/country-04.svg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                        ...
                                        <tr>
                                            <td class="px-0">
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('countries')}}" class="avatar rounded-circle border border-2">
                                                        <img src="{{ asset('admintemplate/assets/img/payment-gateway/country-05.svg') }}" class="img-fluid rounded-circle" alt="img">
                                                    </a>
                                                    <div class="ms-2">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                        <img src="{{ asset('admintemplate/assets/img/users/user-32.jpg') }}" alt="Img">
                                                    </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                        <img src="{{ asset('admintemplate/assets/img/users/user-09.jpg') }}" alt="Img">
                                                    </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                        <img src="{{ asset('admintemplate/assets/img/users/user-33.jpg') }}" alt="Img">
                                                    </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="#" class="avatar avatar-rounded flex-shrink-0 me-2">
                                                        <img src="{{ asset('admintemplate/assets/img/users/user-34.jpg') }}" alt="Img">
                                                    </a>
                        ...
                        <div class="card-body schedule-timeline activity-timeline">
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-fill ps-3 timeline-flow">
                                    <p class="fw-medium text-gray-9 mb-1"><a href="{{url('activity')}}" class="d-flex align-items-center">Meeting With <img src="{{ asset('admintemplate/assets/img/users/user-58.jpg') }}" class="avatar avatar-sm rounded-circle mx-2" alt="Img">Abraham</a></p>
                                    <span>09:25 PM</span>
                                </div>
                            </div>
                        </div>
