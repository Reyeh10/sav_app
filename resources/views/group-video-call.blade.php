        ...
        <div class="content pb-4">
            ...
            <div class="d-flex row-gap-3">
                <div class="main-img flex-fill">
                    <div class="call-img ">
                        <img src="{{ asset('admintemplate/assets/img/call/call-01.jpg') }}" class="img-fluid rounded w-100" alt="img">
                ...
                <div class="chat-active-users">
                    <div class="others guests">
                        <div class="call-img mb-3">
                            <img src="{{ asset('admintemplate/assets/img/call/call-02.jpg') }}" class="img-fluid rounded" alt="img">
                        ...
                        <div class="call-img mb-3">
                            <img src="{{ asset('admintemplate/assets/img/call/call-03.jpg') }}" class="img-fluid rounded" alt="img">
                            <div class="call-overlay-sidedown d-flex justify-content-center align-items-center w-100">
                        ...
                        <div class="call-img mb-3">
                            <img src="{{ asset('admintemplate/assets/img/call/call-05.jpg') }}" class="img-fluid rounded" alt="img">
                            <div class="call-overlay-sidedown d-flex justify-content-center align-items-center w-100">
                                <span class="badge badge-light badge-sm  text-dark fs-10">Joanne Conner </span>
                            </div>
                        </div>
                        <div class="call-img">
                            <img src="{{ asset('admintemplate/assets/img/call/call-06.jpg') }}" class="img-fluid rounded" alt="img">
                            <div class="call-overlay-sidedown d-flex justify-content-center align-items-center w-100">
                                    ...
                                    <div class="chat-msg-blk p-0">
                                        <div class="chats">
                                            <div class="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
                                                <img src="{{ asset('admintemplate/assets/img/users/user-01.jpg') }}" alt="image">
                                            </div>
                                        ...
                                        <div class="chats chats-right">
                                            ...
                                            <div class="avatar avatar-md avatar-rounded flex-shrink-0 ms-2">
                                                <img src="{{ asset('admintemplate/assets/img/users/user-02.jpg') }}" alt="image">
                                            </div>
                                        </div>
                                        <div class="chats">
                                            <div class="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
                                        ...
                                        <div class="chats">
                                            <div class="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
                                                <img src="{{ asset('admintemplate/assets/img/users/user-01.jpg') }}"
                                                    alt="image">
                                            </div>
                                            <div class="chat-content flex-fill">
                                                <div class="message-content">
                                ...
                                <div class="tab-pane fade" id="pills-profile" role="tabpanel">
                                    <div>
                                        <div class="d-flex align-items-center justify-content-between bg-light rounded p-2 mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admintemplate/assets/img/profiles/avatar-11.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between bg-light rounded p-2 mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admintemplate/assets/img/profiles/avatar-12.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between bg-light rounded p-2 mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admintemplate/assets/img/profiles/avatar-13.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between bg-light rounded p-2 mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admintemplate/assets/img/profiles/avatar-15.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium">
                                                        <a href="#">Linda Ray</a>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between bg-light rounded p-2 mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admintemplate/assets/img/profiles/avatar-16.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium">
                                                        <a href="#">Benjamin</a>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between bg-light rounded p-2 mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admintemplate/assets/img/profiles/avatar-17.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium">
                                                        <a href="#">Kaitlin</a>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between bg-light rounded p-2 mb-3">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admintemplate/assets/img/profiles/avatar-18.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium">
                                                        <a href="#">Freda</a>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between bg-light rounded p-2">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar avatar-md avatar-rounded flex-shrink-0 me-2">
                                                    <img src="{{ asset('admintemplate/assets/img/profiles/avatar-20.jpg') }}" alt="Img">
                                                </a>
                                                <div>
                                                    <h6 class="d-inline-flex align-items-center fw-medium">
