                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md bg-light rounded">
                                                <img src="{{ asset('admintemplate/assets/img/icons/apple.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md bg-light rounded">
                                                <img src="{{ asset('admintemplate/assets/img/icons/php.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md bg-light rounded">
                                                <img src="{{ asset('admintemplate/assets/img/icons/black.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                                <h6 class="fw-medium"><a href="#">Junior PHP Developer</a></h6>
                                                <span class="d-block mt-1">20 Applicants</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md bg-light rounded">
                                                <img src="{{ asset('admintemplate/assets/img/icons/react.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md bg-light rounded">
                                                <img src="{{ asset('admintemplate/assets/img/icons/laravel.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md bg-light rounded">
                                                <img src="{{ asset('admintemplate/assets/img/icons/devops.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md bg-light rounded">
                                                <img src="{{ asset('admintemplate/assets/img/icons/android.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md bg-light rounded">
                                                <img src="{{ asset('admintemplate/assets/img/icons/html.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md bg-light rounded">
                                                <img src="{{ asset('admintemplate/assets/img/icons/ui.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <a href="#" class="avatar avatar-md bg-light rounded">
                                                <img src="{{ asset('admintemplate/assets/img/icons/grafic.svg') }}" class="img-fluid rounded-circle" alt="img">
                                            </a>
                                            <div class="ms-2">
