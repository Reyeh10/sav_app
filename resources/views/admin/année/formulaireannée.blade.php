                ...
                <div class="card">
                    <div class="card-body">
                        <div class="border-bottom mb-3 pb-3">
                            <h4>Ajouter un nouvelle année</h4>
                        </div>
...
<!-- ------END---------- Title ---------------------------- -->
    ...
    @endif
        <form method="POST" action="{{ route('admin.année.store') }}">
            @csrf
                            ...
                            <div class="border-bottom mb-3">
                                ...
                                <!--    --------- motif_absence---- ---------------------------- -->
                                    <div class="col-md-6">
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-4">
                                                <label class="form-label mb-md-0">Année</label><span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-md-8">
                                                <!--input type="text" class="form-control"-->
                                                <input name="année" value="{{ old('année') }}" type="text" placeholder="Année" class="form-control form-control-sm" id="smallsize-input"  required />
                                            </div>
                                        </div>
                                    </div>
