...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                    ...
                    <div class="me-2 mb-2">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end p-3">
                                <li>
                                    <a href="{{ route('admin.congé.index') }}"  class="dropdown-item rounded-1"><i class="ti ti-file-type-pdf me-1"></i>Export as PDF</a>
                                </li>
                                <li>
                    ...
                    <div class="mb-2">
                        <a href= "{{ route('admin.congé.formulairecongé') }}" class="btn btn-primary d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>Ajouter un congé</a>
                    ...
                    <div class="custom-datatable-filter table-responsive">
                        <table class="table datatable">
                            ...
                            <!-- -------------  fill out the table -------------------- -->
                                 ...
                                 @foreach ($viewData["congés"] as $congé)
          <tr>
            ...
            <td>
              ...
              <td><small>{{ $congé->getNum_TC() }}</small></td>
              <td><small>{{ $congé->getDate_debut() }}</small></td>
              <td><small>{{ $congé->getDate_fin() }}</small></td>
        ...
        <td>
            ...
            <a href="{{ route('admin.congé.edit', ['id'=> $congé->getid()]) }}" >
        ...
        <td>
              <form action="{{route('admin.congé.delete', $congé->getid())}}" method="POST" >
