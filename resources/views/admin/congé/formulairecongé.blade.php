                ...
                <div class="card">
                    <div class="card-body">
                        <div class="border-bottom mb-3 pb-3">
                            <h4>Ajouter un nouveau congé</h4>
                        </div>
...
<!-- ------END---------- Title ---------------------------- -->
    ...
    @endif
        <form method="POST" action="{{ route('admin.congé.store') }}">
            @csrf
                            ...
                            <div class="border-bottom mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <!--div class="col-md-6">
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-4">
                                                <label class="form-label mb-md-0">ID (type de congé)</label><span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-md-8">
                                                <input name="id_typecongé" value="{ { old('id_typecongé') }}" type="text" placeholder="Type de congé (ID)" class="form-control form-control-sm" id="smallsize-input"  required />
                                            </div>
                                        </div>
                                    </div-->
                                    <div class="col-md-6">
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-4">
                                                <label class="form-label mb-md-0">ID Type congé</label><span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-md-8">

                                                <select name="id_typecongé" id="id_typecongé" class="js-example-basic-single select2 @error('id') is-invalid @enderror" required>
                                                    <option value="">-- Sélectionner --</option>
                                                    @foreach ($typecongés as $typecongé)
                                                        <option value="{{ $typecongé->id }}"
                                                            {{ old('id_typecongé') == $typecongé->id ? 'selected' : '' }}>
                                                            {{ $typecongé->id }} - {{ $typecongé->type_congé }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <!--div class="col-md-6">
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-8">
                                                <input name="id_employé_key" value="{ { old('id_employé_key') }}" type="text" placeholder="ID Employé" class="form-control form-control-sm" id="smallsize-input"  required />
                                            </div>
                                        </div>
                                    </div-->
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-4">
                                                <label class="form-label mb-md-0">Numéro TC</label><span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-md-8">
                                                <!--input type="text" class="form-control"-->
                                                <input name="Num_TC" value="{{ old('Num_TC') }}" type="text" placeholder="Numéro TC" class="form-control form-control-sm" id="smallsize-input"  required />
                                            </div>
                                        </div>
                                    </div>
                                    <!--    --------- Date_debut ---- ---------------------------- -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-4">
                                                <label class="form-label mb-md-0">Date de reprise</label><span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-md-8">
                                                <!--input type="text" class="form-control"-->
                                                <input name="reprise" value="{{ old('reprise') }}" type="date" placeholder="Date de reprise" class="form-control form-control-sm" id="smallsize-input"  required />
                                            </div>
                                        </div>
                                    </div>
                                    <!--    --------- commentaire ---- ---------------------------- -->
