...
@section('content')
                    ...
                    <div class="me-2 mb-2">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end p-3">
                                <li>
                                    <a href="{{ route('admin.employé.index2') }}"  class="dropdown-item rounded-1"><i class="ti ti-file-type-pdf me-1"></i>Export as PDF</a>
                                </li>
                                <li>
    ...
    <!--/body-->
        ...
        <td>
            <!--a href="{ { route('admin.employé.detailemployé', ['id_employé'=> $employé->getid_employé()]) }}" >
                <button class="btn btn-success" style="font-size:08px">
                     <i class="bi-pencil"></i>
                </button>
            </a-->

            <a href="{{ route('admin.employé.edit', ['id_employé'=> $employé->getid_employé()]) }}" >
                <button class="btn btn-success" style="font-size:08px">
                     <i class="bi-pencil"></i>
                </button>
            </a>
            <!--a href="{ { route('admin.employé.edit', ['id_employé'=> $employé->getid_employé()]) }}" class="me-2" data-bs-toggle="modal" data-bs-target="#edit_employee" ><i class="ti ti-edit"></i></a-->
        </td>

        <td>
              <!--form action="{ {route('admin.employé.delete', $employé->getid_employé())}}" method="POST" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="ti ti-trash"></i-->
            ...
            <!--a href="{ {route('admin.employé.delete', $employé->getid_employé())}}" method="POST" data-bs-toggle="modal" data-bs-target="#delete_modal"><i class="ti ti-trash"></i></a-->
        </td>
          </tr>
          @endforeach
            ...
            <!--/div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{ {url('employee-details')}}" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                                src="{ { asset('admintemplate/assets/img/users/user-32.jpg') }}" class="img-fluid rounded-circle" alt="img"></a>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{ {url('employee-details')}}" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                                src="{ { asset('admintemplate/assets/img/users/user-09.jpg') }}" class="img-fluid rounded-circle" alt="img"></a>
                                            <div class="ms-2">
                                                <p class="text-dark mb-0"><a href="{ {url('employee-details')}}" data-bs-toggle="modal"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{ {url('employee-details')}}" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                                src="{ { asset('admintemplate/assets/img/users/user-01.jpg') }}" class="img-fluid rounded-circle" alt="img"></a>
                                            <div class="ms-2">
                                                <p class="text-dark mb-0"><a href="{ {url('employee-details')}}" data-bs-toggle="modal"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{ {url('employee-details')}}" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                                src="{ { asset('admintemplate/assets/img/users/user-33.jpg') }}" class="img-fluid rounded-circle" alt="img"></a>
                                            <div class="ms-2">
                                                <p class="text-dark mb-0"><a href="{ {url('employee-details')}}" data-bs-toggle="modal"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{ {url('employee-details')}}" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                                src="{ { asset('admintemplate/assets/img/users/user-02.jpg') }}" class="img-fluid rounded-circle" alt="img"></a>
                                            <div class="ms-2">
                                                <p class="text-dark mb-0"><a href="{ {url('employee-details')}}" data-bs-toggle="modal"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{ {url('employee-details')}}" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                                src="{ { asset('admintemplate/assets/img/users/user-35.jpg') }}" class="img-fluid rounded-circle" alt="img"></a>
                                            <div class="ms-2">
                                                <p class="text-dark mb-0"><a href="{ {url('employee-details')}}" data-bs-toggle="modal"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{ {url('employee-details')}}" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                                src="{ { asset('admintemplate/assets/img/users/user-36.jpg') }}" class="img-fluid rounded-circle" alt="img"></a>
                                            <div class="ms-2">
                                                <p class="text-dark mb-0"><a href="{ {url('employee-details')}}" data-bs-toggle="modal"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{ {url('employee-details')}}" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                                src="{ { asset('admintemplate/assets/img/users/user-37.jpg') }}" class="img-fluid rounded-circle" alt="img"></a>
                                            <div class="ms-2">
                                                <p class="text-dark mb-0"><a href="{ {url('employee-details')}}" data-bs-toggle="modal"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{ {url('employee-details')}}" class="avatar avatar-md" data-bs-toggle="modal" data-bs-target="#view_details"><img
                                                src="{ { asset('admintemplate/assets/img/users/user-38.jpg') }}" class="img-fluid rounded-circle" alt="img"></a>
                                            <div class="ms-2">
                                                <p class="text-dark mb-0"><a href="{ {url('employee-details')}}" data-bs-toggle="modal"
