                    ...
                    <div class="card card-bg-1">
                        <div class="card-body p-0">
                            ...
                            <div class="text-center px-3 pb-3 border-bottom">
                                <div class="mb-3">
                                    <h5 class="d-flex align-items-center justify-content-center mb-1">{{ $employé->name }}<i class="ti ti-discount-check-filled text-success ms-1"></i></h5>
                            ...
                            <!-- Employee Phone --------------------------------------- -->
                                    ...
                                    <p class="text-dark">{{ $employé->phone }}</p>
                                </div>
                            <!-- Email --------------------------------------- -->
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <a href="javascript:void(0);" class="text-info d-inline-flex align-items-center">{{ $employé->email }}<i class="ti ti-copy text-dark ms-2"></i></a>
                                </div>
                            <!-- Sexe --------------------------------------- -->
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <span class="d-inline-flex align-items-center">
                                    ...
                                    <p class="text-dark text-end">{{ $employé->sexe }}</p>
                                </div>
                            <!-- Birthday --------------------------------------- -->
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <span class="d-inline-flex align-items-center">
                                    ...
                                    <p class="text-dark text-end">{{ $employé->date_naissance }}</p>
                                </div>
                            <!-- Address --------------------------------------- -->
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <p class="text-dark text-end">{{ $employé->address }}</p>
                                </div>
                            <!-- Employee ID --------------------------------------- -->
                                    <!--div class="d-flex align-items-center justify-content-between">
                                        <span class="d-inline-flex align-items-center">
