                                    ...
                                    <div class="col-md-6">
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <!--input name="id_employé" value="{ { old('id_employé', $employé->getid_employé() ?? '') }}" type="text" placeholder="Id Employé" class="form-control form-control-sm" id="smallsize-input" pattern="^[a-zA-Z0-9 ]+$" required /-->
                                            </div>
                                        </div>
                                    </div>
                                <!--    --------- Matricule CNSS ---- ---------------------------- -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <select name="code_activité_key" id="code_activité_key" class="js-example-basic-single select2 @error('code_activité') is-invalid @enderror" required>
                                                    <option value="">-- Sélectionner --</option>
                                                    @foreach ($activités as $activité)
                                                        <option value="{{ $activité->code_activité }}"
                                                            {{ old('code_activité_key') == $activité->code_activité ? 'selected' : '' }}>
                                                            {{ $activité->code_activité }} - {{ $activité->nom_activité }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-8">
                                                <!--input type="text" class="form-control"-->
                                                <input name="id" value="{{ old('id') }}" type="text" placeholder="ID Affectation" class="form-control form-control-sm" id="smallsize-input"  required />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!--div class="col-md-6">
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-8">
                                                <input name="Date_fin" type="date"   data-date-format="mm/dd/yyyy" placeholder="date de fin" class="form-control form-control-sm" id="Date_fin"  value="{{ old('Date_fin') }}" @disabled((old('status') === 'Actuelle')) />
                                    ...
                                    <div class="col-md-6">
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                @php
                                                    $status = old('status', $employe->status ?? '');
                                                @endphp

                                                    <!--select name="status" id="status" class="form-control"-->
                                                    <select name="status" id="status" class="form-control" required>
                                                        <option value="">-- Choisir le  status --</option>
                                                        <option value="Actuelle" {{ $status === 'Actuelle' ? 'selected' : '' }}>Actuelle</option>
                                                        <option value="Ancienne" {{ $status === 'Ancienne' ? 'selected' : '' }}>Ancienne</option>
                                                    </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-8">
                                                <input
                                                    ...
                                                    value="{{ old('Date_fin', $employe->Date_fin ?? '') }}"
                                                    @disabled($status === 'Actuelle')
                                                >
                                    ...
                                    <script>
                                        document.addEventListener('DOMContentLoaded', function () {
                                            ...
                                            const dateField = document.getElementById('Date_fin');

                                            function updateDateField() {
                                                if (status.value === 'Actuelle') {
                                                    dateField.disabled = true;
                                                    dateField.value = ''; // facultatif : vider le champ
                                                } else {
                                                    dateField.disabled = false;
                                                }
                                            }

                                            status.addEventListener('change', updateDateField);
                                            updateDateField(); // déclenche au chargement
                                        });
                                    </script>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <select name="code_poste_key" id="code_poste_key" class="js-example-basic-single select2 @error('code_poste') is-invalid @enderror" required>
                                                    <option value="">-- Sélectionner --</option>
                                                    @foreach ($postes as $poste)
                                                        <option value="{{ $poste->code_poste }}"
                                                            {{ old('code_poste_key') == $poste->code_poste ? 'selected' : '' }}>
                                                            {{ $poste->code_poste }} - {{ $poste->nom_poste }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <select name="code_service_key" id="code_service_key" class="js-example-basic-single select2 @error('code_service') is-invalid @enderror" required>
                                                    <option value="">-- Sélectionner --</option>
                                                    @foreach ($services as $service)
                                                        <option value="{{ $service->code_service }}"
                                                            {{ old('code_service_key') == $service->code_service ? 'selected' : '' }}>
