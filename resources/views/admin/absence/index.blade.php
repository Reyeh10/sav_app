...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="content">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                ...
                <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                    ...
                    <div class="me-2 mb-2">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu  dropdown-menu-end p-3">
                                <li>
                                    <a href="{{ route('admin.absence.index') }}"  class="dropdown-item rounded-1"><i class="ti ti-file-type-pdf me-1"></i>Export as PDF</a>
                                </li>
                                <li>
                    ...
                    <div class="mb-2">
                        <a href= "{{ route('admin.absence.formulaireabsence') }}" class="btn btn-primary d-flex align-items-center"><i class="ti ti-circle-plus me-2"></i>Ajouter une absence</a>
          ...
          <tr>
            ...
            <td>
              ...
              <td><small>{{ $absence->getid() }}</small></td>
              <td><small>{{ $absence->getDate_debut() }}</small></td>
              <td><small>{{ $absence->getDate_fin() }}</small></td>
              <!--td><small>{ { $absence->getreprise() }}</small></td>
              <td><small>{ { $absence->getstatus() }}</small></td-->
        ...
        <td>
            ...
            <a href="{{ route('admin.absence.edit', ['id'=> $absence->getid()]) }}" >
        ...
        <td>
              <form action="{{route('admin.absence.delete', $absence->getid())}}" method="POST" >
